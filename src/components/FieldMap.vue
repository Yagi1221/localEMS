  ...
  <div class="row text-center mb-3">
    ...
    <div class="col-12 row d-flex justify-content-around text-white">
      ...
      <div class="col-3 p-2 border cursor-pointer" @click="toCabinetList('CABINET_1')">
        <div class="row m-0 ">
          <div
            :class="'col-6 border mb-1  d-flex justify-content-center align-items-center ' + getClass('CABINET_1', 'air_abnormal')"
            style="height:3rem">空調</div>
          <div
            :class="'col-6 border mb-1  d-flex justify-content-center align-items-center' + getClass('CABINET_1', 'fire_abnormal')"
            style="height:3rem">消防</div>
        </div>
        ...
        <div class="row m-0">
          <div
            :class="'border mb-1  d-flex justify-content-center align-items-center' + getClass('CABINET_1', 'abnormal')"
            style="height:6rem">主控中心</div>
        </div>
      </div>
      ...
      <div class="col-3 row p-2 border cursor-pointer" @click="toCabinetList('CABINET_2')">
        ...
        <div
          :class="'col-6 border mb-1 d-flex justify-content-center align-items-center' + getClass('CABINET_2', 'air_abnormal')"
          style="height:3rem">空調</div>
        <div
          :class="'col-6 border mb-1 d-flex justify-content-center align-items-center' + getClass('CABINET_2', 'fire_abnormal')"
          style="height:3rem">消防</div>
      ...
      <div class="col-3 row p-2 border cursor-pointer" @click="toCabinetList('CABINET_3')">
        ...
        <div
          :class="'col-6 border mb-1 d-flex justify-content-center align-items-center' + getClass('CABINET_3', 'air_abnormal')"
          style="height:3rem">空調</div>
        <div
          :class="'col-6 border mb-1 d-flex justify-content-center align-items-center' + getClass('CABINET_3', 'fire_abnormal')"
          style="height:3rem">消防</div>
